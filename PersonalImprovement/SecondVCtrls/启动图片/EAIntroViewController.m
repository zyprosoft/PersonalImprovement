...
@interface EAIntroViewController () <EAIntroDelegate,UITableViewDataSource> {
    UIView *rootView;
    EAIntroView *_intro;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        case 0:{
            title = @"showIntroWithCrossDissolve";
            subtitle = @"pages with custom packgrounds & title images";
        }break;
        case 1:{
            title = @"showIntroWithFixedTitleView";
            subtitle = @"introView colored background & fixed title image";
        }break;
        case 2:{
            title = @"showIntroWithCustomPages";
            subtitle = @"basic pages with custom settings";
        }break;
        case 3:{
            title = @"showIntroWithCustomView";
            subtitle = @"using page with custom view";
        }break;
        case 4:{
            title = @"showIntroWithCustomViewFromNib";
            subtitle = @"using page with custom view from nib";
        }break;
        case 5:{
            title = @"showIntroWithSeparatePagesInitAndPageCallback";
            subtitle = @"separate init and using page block callback";
        }break;
        case 6:{
            title = @"showCustomIntro";
            subtitle = @"show custom intro";
        }break;
        default:
            break;
    }
