...
@interface OnboardVCtrl ()

@end

@implementation OnboardVCtrl

- (void)viewDidLoad {
    [super viewDidLoad];

    // otherwise set the root view controller to the onboarding view controller
    KCurrentWindow.rootViewController = [self generateStandardOnboardingVC];
//  KCurrentWindow.rootViewController = [self generateMovieOnboardingVC];
}
...
- (void)setupNormalRootViewController {
    ...
    KCurrentWindow.rootViewController = [[UINavigationController alloc] initWithRootViewController:mainVC];
}
