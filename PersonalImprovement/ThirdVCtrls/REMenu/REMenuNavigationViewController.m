...
#import "REMenuExploreViewController.h"
#import "REMenuActivityViewController.h"
#import "REMenuProfileViewController.h"

@interface REMenuNavigationViewController ()

@property (strong, readwrite, nonatomic) REMenu *menu;

@end

@implementation REMenuNavigationViewController
...
- (void)viewDidLoad
{
    ...
    REMenuItem *homeItem = [[REMenuItem alloc] initWithTitle:@"Home"
                                            ...
                                            highlightedImage:nil
                                                      action:^(REMenuItem *item) {
                                                          NSLog(@"Item: %@", item);
                                                          REMenuHomeViewController *controller = [[REMenuHomeViewController alloc] init];
    ...
    REMenuItem *exploreItem = [[REMenuItem alloc] initWithTitle:@"Explore"
                                               ...
                                               highlightedImage:nil
                                                         action:^(REMenuItem *item) {
                                                             NSLog(@"Item: %@", item);
                                                             REMenuExploreViewController *controller = [[REMenuExploreViewController alloc] init];
                                                             [weakSelf setViewControllers:@[controller] animated:NO];
                                                         }];
    ...
    REMenuItem *activityItem = [[REMenuItem alloc] initWithTitle:@"Activity"
                                                ...
                                                highlightedImage:nil
                                                          action:^(REMenuItem *item) {
                                                              NSLog(@"Item: %@", item);
                                                              REMenuActivityViewController *controller = [[REMenuActivityViewController alloc] init];
                                                              [weakSelf setViewControllers:@[controller] animated:NO];
                                                          }];
    ...
    REMenuItem *profileItem = [[REMenuItem alloc] initWithTitle:@"Profile"
                                               ...
                                               highlightedImage:nil
                                                         action:^(REMenuItem *item) {
                                                             NSLog(@"Item: %@", item);
                                                             REMenuProfileViewController *controller = [[REMenuProfileViewController alloc] init];
                                                             [weakSelf setViewControllers:@[controller] animated:NO];
                                                         }];
