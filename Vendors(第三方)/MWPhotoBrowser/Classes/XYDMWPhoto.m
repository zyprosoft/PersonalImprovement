...
+ (XYDMWPhoto *)photoWithImage:(UIImage *)image {
	return [[XYDMWPhoto alloc] initWithImage:image];
}

+ (XYDMWPhoto *)photoWithURL:(NSURL *)url {
    return [[XYDMWPhoto alloc] initWithURL:url];
}

+ (XYDMWPhoto *)photoWithAsset:(PHAsset *)asset targetSize:(CGSize)targetSize {
    return [[XYDMWPhoto alloc] initWithAsset:asset targetSize:targetSize];
}

+ (XYDMWPhoto *)videoWithURL:(NSURL *)url {
    return [[XYDMWPhoto alloc] initWithVideoURL:url];
}
...
#pragma mark - XYDMWPhoto Protocol Methods
