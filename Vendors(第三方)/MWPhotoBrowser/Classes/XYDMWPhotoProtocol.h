...
// Otherwise you can use the XYDMWPhoto object or subclass it yourself to
// store more information per photo.
//
// You can see the XYDMWPhoto class for an example implementation of this protocol
//
@protocol XYDMWPhoto <NSObject>
...
// See XYDMWPhoto object for an example implementation.
