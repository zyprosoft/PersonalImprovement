...
@interface XYDMWZoomingScrollView () {
    
    XYDMWPhotoBrowser __weak *_photoBrowser;
	XYDMWTapDetectingView *_tapView; // for background taps
	XYDMWTapDetectingImageView *_photoImageView;
...
@implementation XYDMWZoomingScrollView
...
- (id)initWithPhotoBrowser:(XYDMWPhotoBrowser *)browser {
    if ((self = [super init])) {
		...
		_tapView = [[XYDMWTapDetectingView alloc] initWithFrame:self.bounds];
		...
		// Image view
		_photoImageView = [[XYDMWTapDetectingImageView alloc] initWithFrame:CGRectZero];
