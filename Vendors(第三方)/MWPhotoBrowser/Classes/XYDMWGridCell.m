...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        UIImage *videoIndicatorImage = [UIImage imageForResourcePath:@"VideoOverlay" ofType:@"png" inBundle:[NSBundle mainBundle]];
        ...
        [_selectedButton setImage:[UIImage imageForResourcePath:@"ImageSelectedSmallOff" ofType:@"png" inBundle:[NSBundle mainBundle]] forState:UIControlStateNormal];
        [_selectedButton setImage:[UIImage imageForResourcePath:@"ImageSelectedSmallOn" ofType:@"png" inBundle:[NSBundle mainBundle]] forState:UIControlStateSelected];
...
- (void)setGridController:(XYDMWGridViewController *)gridController {
...
- (void)setPhoto:(id <XYDMWPhoto>)photo {
    _photo = photo;
...
- (void)showImageFailure {
    ...
    if (![_photo respondsToSelector:@selector(emptyImage)] || !_photo.emptyImage) {
        if (!_loadingError) {
            ...
            _loadingError.image = [UIImage imageForResourcePath:@"ImageError" ofType:@"png" inBundle:[NSBundle mainBundle]];
...
- (void)setProgressFromNotification:(NSNotification *)notification {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        id <XYDMWPhoto> photoWithProgress = [dict objectForKey:@"photo"];
