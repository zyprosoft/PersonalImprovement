...
@interface XYDMWCaptionView : UIToolbar

// Init
- (id)initWithPhoto:(id<XYDMWPhoto>)photo;
...
// If you need more data per photo then simply subclass XYDMWPhoto and return your
