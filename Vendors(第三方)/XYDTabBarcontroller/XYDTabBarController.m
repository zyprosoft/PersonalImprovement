...
- (instancetype)initWithViewControllers:(NSArray<UIViewController *> *)viewControllers plusButton:(XYDPlusButton<XYDPlusButtonProtocol> *)plusButton tabBarItemsAttributes:(NSArray<NSDictionary *> *)tabBarItemsAttributes {
...
+ (instancetype)tabBarControllerWithViewControllers:(NSArray<UIViewController *> *)viewControllers plusButton:(XYDPlusButton<XYDPlusButtonProtocol> *)plusButton tabBarItemsAttributes:(NSArray<NSDictionary *> *)tabBarItemsAttributes {
